...
```bash
git clone https://github.com/PNX89/QUACKZ.git && cd QUACKZ
...
https://pnx89.github.io/QUACKZ, come from a real run whose output is committed under
